...
//
//    public TaskForAssistantController(TaskForAssistantService taskForAssistantService,
...
//    public ResponseEntity<BodyResponseDTO<Object>> createTaskForDepartment(@RequestBody TaskForAssistant req,
//                                                                           HttpServletRequest request) {
//        logHttpRequest(request);
//        return RestResponseWrapper.getResponse(HttpStatus.OK,
//                ApiResponseCode.SUCCESS,
//                this.messageUtils,
//                taskForAssistantService.saveTFA(req));
//    }
//
//    @PutMapping(value = "/edit/{id}")
//    public ResponseEntity<BodyResponseDTO<Object>> editTaskForDepartment(@RequestBody TaskForAssistant req,
...
//                ApiResponseCode.SUCCESS,
//                this.messageUtils,
//                taskForAssistantService.editTFA(req, id));
//    }
//
...
//                ApiResponseCode.SUCCESS,
//                this.messageUtils,
//                taskForAssistantService.getTFAByID(id));
//    }
//
//}
